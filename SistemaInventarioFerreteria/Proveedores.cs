    ...
    public partial class frmProveedores : Form
    {
        ...
        private void FiltrarProveedores(String valor, int opcion)
        {
            try
            {
                ...
                erpProveedores.SetError(txtBuscarProveedor, "");
            }
            catch (Exception e)
            {
                erpProveedores.SetError(txtBuscarProveedor, "Por favor Ingrese un nombre o Telefono de Proveedor");
        ...
        {
            if (txtNombreProveedor.Text == "" && txtTelefonoProveedor.Text == "" && txtDireccionProveedor.Text == "" && txtEmailProveedor.Text == "")
            {
        ...
        private void btnActualizarProveedor_Click_1(object sender, EventArgs e)
        {
            ...
            if (btnActualizarProveedor.Text == "Modificar")
            {
                ...
                {
                    posicion = dgvProveedores.SelectedRows[0].Index;
                }
            }
            else
            {
