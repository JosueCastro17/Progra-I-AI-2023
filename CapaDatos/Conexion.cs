...
namespace CapaDatos
{
    public class Conexion
    {
        ...
        public Conexion()
        {
            String cadenaConexion = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Gerso\source\repos\SistemaInventarioFerreteria\SistemaInventarioFerreteria\SistemaInventario.mdf;Integrated Security=True";
